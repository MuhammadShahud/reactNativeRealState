...
import { QUESTIONOFTHEDAY } from '../Redux/Reducers/AuthReducer';
import { useSelector } from 'react-redux';

export default function QueScreen(props) {
    const questions = useSelector(QUESTIONOFTHEDAY)
    const data =  props.route.params.subject == 'QuestionOfTheDay' ? [questions[0]] :
    props.route.params.subject == 'QuickQuestions' ? questions : null
