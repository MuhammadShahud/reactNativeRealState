...
import {StyleSheet, Text, Pressable, View, Alert, ScrollView} from 'react-native';
...
title === "Practice Test"?
  navigation.navigate('PracticeQuestion',{title: 'Practice Test'}) :
title === "Missed Question Test"?
  ...
  return (
      ...
      <ScrollView style={stylesSeperate.container}>
