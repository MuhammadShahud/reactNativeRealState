...
const HomeProgess = props => {
  ...
  return user?.subscription?(
    ...
    onPress={props.onPress}
    style={[styles.boxStyle,!user?.subscription? {height:hp('13%'),backgroundColor: props.background,justifyContent:'center'}:
    {backgroundColor: props.background,justifyContent:'center'}]}>
