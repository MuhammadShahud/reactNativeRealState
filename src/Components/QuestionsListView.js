  ...
  return (
    user?.subscription? (
      ...
      <View style={{width: wp('20%'), alignItems: 'center'}}>
        {/* <Image source={props.item.Image} resizeMode='cover' style={{ width: wp('18%'), height: wp('19%') }} /> */}
        <BOOKSICON/>
      ...
      <View style={{alignItems: 'flex-start'}}>
        ...
        <View
          ...
          {/* <View style={{ width: wp('50%'), height: hp('1.5%'), backgroundColor: '#757DFE', borderRadius: wp('50%') }}> */}
          <View
            style={{
