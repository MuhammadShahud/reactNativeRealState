...
import {EraseAllData, Login} from '../Redux/Actions/AuthAction';
      ...
      {!user ? (
        <View
          ...
          <View style={{width: wp('40%')}}>
            <SecondaryButton onPress={() => navigation.navigate('Subscription')} title="Subscribe" />
          </View>
        </View>
      ) : (
        <View
